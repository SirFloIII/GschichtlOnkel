...
Another interesting experiment would involve generating the Reeb Graph via an external library, dissect it to generate a slope region decomposition, and then pitting the resulting algorithm against BP. Let the games begin!
