...
- For each levelset in bottom to top order:
    - add points to regions if they are in the halo of a region.
    - if an added point is in the halo of different region:
        - find the union of the halos of the involved regions
    ...
    - if an added point splits the halo of the region in two:
        - reduce the halo the region to one component
        - for each other component:
            - create a new region containing the component as halo
